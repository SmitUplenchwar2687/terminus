...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    number: '02',
    name: 'REDPRINT',
    tagline: 'Backend infrastructure for fitness ecosystems',
    description: 'Backend platform powering a fitness app ecosystem — PostgreSQL migration, idempotent payment APIs, and Gemini LLM invoice classification.',
    fullDescription: 'Backend infrastructure platform powering a fitness application ecosystem. Migrated from Firebase to PostgreSQL for transactional integrity, built idempotent payment APIs with FX-adjusted pricing, and integrated Gemini LLM for intelligent invoice classification. Go and Python services on AWS.',
    tags: ['Go', 'Python', 'PostgreSQL', 'AWS', 'Firebase'],
  ...
  },
  {
    ...
    tagline: 'LangGraph-powered recruiting pipeline',
    description: 'Intelligent recruiting pipeline with LangGraph agent orchestration — automated candidate sourcing, screening, and outreach for physician recruitment.',
    fullDescription: 'An intelligent recruiting pipeline built with LangGraph agent orchestration. Automated candidate sourcing, screening, and outreach for physician recruitment. Multi-step agent workflows with tool-calling, memory, and human-in-the-loop checkpoints.',
    tags: ['Python', 'LangGraph', 'AI/ML', 'Agents'],
    githubUrl: 'https://github.com/smituplenchwar2687',
    shape: 'octahedron',
  },
  {
    ...
    tagline: 'gRPC microservices for time-series forecasting',
    description: 'Microservices-based forecasting system with 4 gRPC services, 12+ algorithms, JWT auth, and Docker Compose orchestration.',
    fullDescription: 'Microservices-based forecasting system with 4 gRPC services behind an API gateway. Implements 12+ forecasting algorithms with JWT-authenticated access. Built with Protocol Buffers, Docker Compose orchestration, and comprehensive integration test suites.',
    tags: ['gRPC', 'Microservices', 'JWT', 'Docker', 'Protocol Buffers'],
    githubUrl: 'https://github.com/smituplenchwar2687',
    shape: 'cone',
  },
]
